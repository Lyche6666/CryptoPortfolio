// src/lib.rs
/*
 * Core library for CryptoPortfolio
 */
...
#[derive(Debug)]
pub struct CryptoPortfolioProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoPortfolioProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoPortfolio processing");
    
    let mut processor = CryptoPortfolioProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoPortfolioProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoPortfolioProcessor::new(false);
